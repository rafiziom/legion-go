...
echo "\nRepozytorium projektu: https://github.com/rafiziom/legion-go.git"
echo "Jeśli chcesz pobrać lub zaktualizować projekt, użyj:"
echo "git clone https://github.com/rafiziom/legion-go.git"
echo "cd legion-go"
